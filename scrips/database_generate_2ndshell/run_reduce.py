'''
This is the command I use for the reduce program, where BUILD adds hydrogens, FLIP rotates and flips asn gln his hydrogens, (I think having both BUILD and FLIP are redundant but I don't have evidence), and Quiet suppresses verbose output (optional):
reduce -BUILD -FLIP -Quiet oldpdb.pdb > newpdb.PDB

I just realized the gpu computer doesn’t have reduce anymore. Or if it does, I don't know where the path is. However, it’s in the wynton amber installation: /wynton/home/grabe/shared/amber/amber18/bin/reduce
