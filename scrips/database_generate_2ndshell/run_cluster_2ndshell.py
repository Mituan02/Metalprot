'''
2ndshell Hbond interaction is extracted based on distance cutoff of 3.4.
The script cluster the 2ndshell vdms. To run the script, run database_prep_2ndshell.py first. Then run '.../search_2ndshell_pickle.py' to get the pickle form.
'''
