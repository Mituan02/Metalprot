...
'''
python /Users/lonelu/GitHub_Design/Metalprot/scrips/search_selfcenter/database_selfcenter_pickle.py
'''

'''General ZN database path'''
query_dir = '/Users/lonelu/DesignData/ligands_metal/ZN_rcsb_datesplit/20211013/20211013_selfcenter/'
query_dir = '/Users/lonelu/DesignData/ligands_metal/ZN_rcsb_datesplit/20211013/20231020_HDE_selfcenter_C_category/'
...
#file_name_not_includes=['@', 'CYS']
file_name_not_includes=['@']
centroid_querys = extract_vdm.extract_all_centroid(query_dir, summary_name = '_summary.txt', file_name_includes = ['AAMetalPhiPsi', 'cluster'], file_name_not_includes=file_name_not_includes, score_cut = 0, clu_num_cut = 0)
