...
workdir = '/wynton/home/degradolab/lonelu/GitHub_Design/Combs2_library/ntf2_sub/'

predefined_win_filters = [[16, 17, 84]]
...
def main():
    ...
    run(target_path, win_filter, outdir, resnums)
    return


def run(target_path, win_filter, outdir, resnums):
